...
<head>
    ...
    <title>Pustok - Online Bookstore, New Books, Book Sale!</title>
                        ...
                        <div class="col-lg-6">
                            <div class="main-navigation flex-lg-right">
                                <ul class="main-menu menu-right " style="display: -webkit-inline-box;">
                                    ...
                                    <!-- Shop -->
                                    <li class="menu-item">
                                        <a href="tat-ca-san-pham.php">Products</a>
                                    </li>
                                    <li class="menu-item">
                                        <a href="lien-he.php">Contact</a>
                                    </li>
                                    <li class="menu-item">
                                        <a href="tai-khoan.php">Account</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-5">
                            <form method="GET" action="tim-kiem.php">
                                <div class="header-search-block">
                                    <input type="text" placeholder="Searching product..." name="tensach">
                                ...
                                <div class="cart-widget">
                                    <?php if(isset($_SESSION['dangnhap'])){ ?>
                                        <div class="login-block">
                                            ...
                                            <a href="dang-xuat.php">Logout</a>
                                        </div>
                                    <?php }else{ ?>
                                        <div class="login-block">
                                            <a href="dang-nhap.php" class="font-weight-bold">Login</a> <br>
                                            <span>hoặc</span><a href="dang-nhap.php">Sign Up</a>
                                        </div>
                                    <?php } ?>
