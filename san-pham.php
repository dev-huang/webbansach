                ...
                <div class="breadcrumb-contents">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="tat-ca-san-pham.php">Products</a></li>
                    ...
                    <div class="col-lg-7">
                        <div class="product-details-info pl-lg--30 ">
                            ...
                            <ul class="list-unstyled">
                                <li>Discount: <span class="list-value"> - <?php echo number_format($sanpham['giagoc'] - $sanpham['giaban']); ?></span></li>
                                <li>Category: <a href="#" class="list-value font-weight-bold"> <?php echo $cm['tenchuyenmuc']; ?></a></li>
                                <li>Product id: <span class="list-value"> #sach<?php echo $sanpham['masanpham']; ?></span></li>
                                <li>Product status: <span class="list-value"> In Stock</span></li>
                            </ul>
                            ...
                            <div class="add-to-cart-row">
                                ...
                                <div class="add-cart-btn">
                                    <a href="" class="btn btn-outlined--primary themgiohang"><span class="plus-icon">+</span>Add to Cart</a>
                                </div>
                            </div>
                        </div>
                    </div>
