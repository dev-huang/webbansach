...
$danhchoban = queryResult($conn,$sql_danhchoban);
 ?>
        ...
        <section class="section-margin">
            <h2 class="sr-only">Advertising</h2>
            <div class="container">
                        ...
                        <div class="promo-wrapper promo-type-one">
                            ...
                            <div class="promo-text">
                                <div class="promo-text-inner">
                                    ...
                                    <h3>Up to 50% off for customers</h3>
                                    <a href="tat-ca-san-pham.php" class="btn btn-outlined--red-faded">VIEW MORE</a>
                                </div>
                            </div>
                        </div>
                    </div>
