			...
			<nav aria-label="Page navigation example">
				...
				<ul class="pagination" style="justify-content: center;">
					<?php if(isset($_GET['trang'])){ ?>
						<li class="page-item"><a class="page-link" href="./tat-ca-san-pham.php?trang=<?php echo $_GET['trang'] - 1; ?>">Previous</a></li>
					<?php }else{ ?>
					...
					<?php if(isset($_GET['trang']) && $sotrang >= 2 && $sotrang != $_GET['trang']){ ?>
						<li class="page-item"><a class="page-link" href="./tat-ca-san-pham.php?trang=<?php echo $_GET['trang'] + 1; ?>">Next</a></li>
					<?php }else{ ?>
